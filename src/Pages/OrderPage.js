...
const OrderPage = () => {
  ...
  return (
    <div>
      ...
      <div className={`vw-100 vh-100 ${styles.bg}`}>
        <h1 className="d-block m-3 bold text-center">주문서 작성</h1>
        <div className={`bg-white ${styles.bill}`}>
          <p className="bold fs-5 mb-1">주문 상품 목록()</p>
          ...
          <div className={`d-flex flex-row`}>
            <div className={`mt-3 flex-grow-3 ${styles.leftSide}`}>
              ...
              <hr></hr>
              <div>
                <p className="bold fs-5">주문자 정보</p>
                <table class={`${styles.tbl_order}`}>
                  <tbody>
                    <tr>
                      <th scope="row">이름</th>
                      <td>
                    ...
                    <tr className={`${styles.phone}`}>
                      ...
                      <td>
                        ...
                        - <input type="text" data-require_msg="휴대폰번호를" /> -
                        <input type="text" data-require_msg="휴대폰번호를" />
                      </td>
                    </tr>
                    <tr className={`${styles.email}`}>
                      <th scope="row">이메일</th>
                      <td>
                        <input type="text" data-require_msg="이메일주소를" />
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <hr />
              <div>
                <p className="bold fs-5">배송지 정보</p>
              </div>
            </div>
